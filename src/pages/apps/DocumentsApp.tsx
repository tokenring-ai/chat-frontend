        ...
        <div className="flex rounded-lg border border-primary overflow-hidden shrink-0">
          <button
            ...
            className={cn(
              ...
              rightPanel === "preview" ? "bg-indigo-600 text-white" : "text-muted hover:text-primary hover:bg-hover",
            )}
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium transition-colors focus-ring cursor-pointer",
              rightPanel === "ai" ? "bg-indigo-600 text-white" : "text-muted hover:text-primary hover:bg-hover",
            )}
          ...
          >
            ...
            {selection && rightPanel !== "ai" && <span className="w-1.5 h-1.5 bg-indigo-400 rounded-full animate-pulse" />}
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col min-w-0 border-r border-primary">
          ...
          <div className="shrink-0 h-8 border-t border-primary bg-secondary flex items-center px-4 gap-4 text-2xs text-muted select-none">
            ...
            {selection && <span className="text-indigo-400 font-semibold">{selection.end - selection.start} chars selected</span>}
          </div>
        </div>
